...
export default function SVMForm({
  onFileChange,
  onTargetChange,
  targetColumn,
  columns,
          ...
          <div className="space-y-4">
                  ...
                  {gamma === "custom" && (
                    <div className="mt-2">
                      <input
                        ...
                        value={customGamma}
                        onChange={(e) =>
                          setCustomGamma(parseFloat(e.target.value))
                        }
                        className="w-full p-3 rounded-lg bg-white dark:bg-zinc-800 border border-gray-300 dark:border-zinc-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                        placeholder="e.g., 0.1"
                      />
            ...
            <div className="flex items-center space-x-2">
              <input
                ...
                id="shrinking"
                checked={shrinking}
                onChange={(e) => setShrinking(e.target.checked)}
            ...
            {/* Probability Estimates Toggle */}
            <div className="flex items-center space-x-2">
              <input
                type="checkbox"
                id="probability"
                checked={probability}
                onChange={(e) => setProbability(e.target.checked)}
                className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
              />
              <label
                htmlFor="probability"
              ...
              <span className="text-xs text-gray-500 dark:text-zinc-400 ml-1">
                (Slower but provides predict_proba)
              </span>
            </div>
