...
export default function ElasticNetResult({ result, error, targetColumn }) {
  ...
  // Regularization type based on l1_ratio
  const regularizationType = useMemo(() => {
    const l1Ratio = result?.l1_ratio || 0.5;
    if (l1Ratio === 0) return "Ridge";
    if (l1Ratio === 1) return "Lasso";
    if (l1Ratio < 0.5) return "Ridge-heavy";
    if (l1Ratio > 0.5) return "Lasso-heavy";
    return "Balanced";
  }, [result?.l1_ratio]);
      ...
      <div className="space-y-6">
        ...
        {result && (
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="p-4 rounded-lg border border-gray-200 dark:border-zinc-800 bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/10 dark:to-purple-900/10">
                ...
                <div className="text-xs text-gray-500 dark:text-zinc-500">
                  L1 Ratio: {l1Ratio.toFixed(2)} (α={alpha.toFixed(2)})
                </div>
              </div>
              ...
              <>
                ...
                <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <div className="space-y-3">
                      <div className="p-3 rounded-lg border border-gray-200 dark:border-zinc-800 bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/10 dark:to-purple-900/10">
                        <div className="text-sm text-gray-600 dark:text-zinc-400 mb-1">
                      ...
                      <div className="p-3 rounded-lg border border-gray-200 dark:border-zinc-800 bg-gray-50 dark:bg-zinc-800/50">
                        ...
                        <div className="text-xs text-gray-500 dark:text-zinc-500 mt-1">
                          {l1Ratio === 0 ? "Pure Ridge (L2)" : 
                           l1Ratio === 1 ? "Pure Lasso (L1)" : 
                           l1Ratio < 0.5 ? "Ridge-heavy" : 
                           l1Ratio > 0.5 ? "Lasso-heavy" : "Balanced"}
                        </div>
                      </div>
                      <div className="p-3 rounded-lg border border-gray-200 dark:border-zinc-800 bg-gray-50 dark:bg-zinc-800/50">
                        <div className="text-sm text-gray-600 dark:text-zinc-400 mb-1">
            ...
            <div className="mt-6 p-4 rounded-lg border border-gray-200 dark:border-zinc-800 bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20">
              <h4 className="text-lg font-semibold mb-2 text-gray-800 dark:text-zinc-200">
                ElasticNet Model Interpretation
              </h4>
              <div className="text-sm text-gray-600 dark:text-zinc-400 space-y-2">
                ...
                <p>
                  <strong>Regularization Type:</strong>{" "}
                  {l1Ratio === 0 ? "Pure Ridge (L2) - All features retained with shrinkage" :
                   l1Ratio === 1 ? "Pure Lasso (L1) - Feature selection, coefficients can be zero" :
                   l1Ratio < 0.5 ? "Ridge-heavy - Mostly shrinkage, some feature selection" :
                   l1Ratio > 0.5 ? "Lasso-heavy - Mostly feature selection, some shrinkage" :
                   "Balanced ElasticNet - Equal mix of L1 and L2 regularization"}
                </p>
                <p>
                  <strong>Feature Selection:</strong>{" "}
                  {coefficientData.filter((c) => Math.abs(c.coefficient) < 0.0001).length}{" "}
                  features were effectively set to zero. This simplifies the model and reduces overfitting.
                </p>
                <p>
                  <strong>Alpha ({alpha.toFixed(2)}):</strong>{" "}
                  {alpha > 1
                    ? "Strong regularization - significant coefficient shrinkage"
                    : alpha > 0.1
                    ? "Moderate regularization - balanced shrinkage"
                    : "Weak regularization - minimal shrinkage"}
                </p>
                {result.model_id && (
        ...
        {!result && !error && (
          <div className="text-center py-12 text-gray-500 dark:text-zinc-400">
            ...
            <p>
              Upload your data and train the ElasticNet Regression model to see
