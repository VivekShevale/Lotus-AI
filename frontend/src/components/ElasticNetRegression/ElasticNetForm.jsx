...
export default function ElasticNetForm({
  onFileChange,
  onTargetChange,
  targetColumn,
  columns,
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <p className="mt-1 text-xs text-gray-500 dark:text-zinc-400">
              Method for updating coefficients
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {/* Fit Intercept */}
          <div
            className="flex items-center p-4 rounded-lg border border-gray-200 dark:border-zinc-700 bg-gray-50 dark:bg-zinc-800/50 hover:bg-gray-100 dark:hover:bg-zinc-700/50 transition-colors cursor-pointer"
            ...
            >
              <span
                className={`inline-block h-4 w-4 transform rounded-full bg-white transition-all duration-300 ${
                  fitIntercept ? "translate-x-6" : "translate-x-1"
                }`}
              />
            </div>
            <div>
          ...
          <div
            className="flex items-center p-4 rounded-lg border border-gray-200 dark:border-zinc-700 bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/10 dark:to-purple-900/10 hover:shadow-md transition-all duration-300 cursor-pointer"
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <h4 className="font-semibold text-gray-800 dark:text-zinc-200 text-sm mb-2">
                ElasticNet Regression Information
              </h4>
              <div className="text-xs text-gray-600 dark:text-zinc-400 space-y-1">
                <p>
                  <span className="font-medium">ElasticNet:</span> Linear model with 
                  both L1 (Lasso) and L2 (Ridge) regularization
                </p>
                <p>
                  <span className="font-medium">Alpha:</span> Overall regularization 
                  strength. Higher values increase regularization.
                </p>
                <p>
                  <span className="font-medium">L1 Ratio:</span> Balance between 
                  L1 and L2 regularization (0 = Ridge, 1 = Lasso, 0.5 = ElasticNet)
                </p>
                <p>
                  <span className="font-medium">Benefits:</span> Combines feature 
                  selection of Lasso with regularization benefits of Ridge
                </p>
                <p>
                  <span className="font-medium">Smart Data Cleaning:</span>{" "}
                  {enableDataCleaning
                    ? "Enabled - Automatic handling of missing values, outliers, and data normalization"
                    : "Disabled - Use raw data as provided without preprocessing"}
                </p>
              </div>
            </div>
          </div>
