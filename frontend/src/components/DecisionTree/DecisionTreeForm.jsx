        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          {/* Criterion Selection */}
            ...
            <p className="mt-1 text-xs text-gray-500 dark:text-zinc-400">
                {criterion === "gini" 
                ? "Gini: Faster, works well with most datasets" 
                : "Entropy: More computationally expensive, tends to create balanced trees"}
            </p>
            </div>
            ...
            />
            <p className="mt-1 text-xs text-gray-500 dark:text-zinc-400">
                Controls tree depth. Higher values = more complex trees
            </p>
            </div>

            {/* Min Samples Split Input */}
            <div>
            <label className="block text-gray-700 dark:text-zinc-300 mb-2 text-sm font-medium">
            ...
            <input
                ...
                if (!isNaN(intValue) && intValue >= 2) {
                    setMinSamplesSplit(intValue);
                }
                }}
                className="w-full p-3 rounded-lg bg-white dark:bg-zinc-800 border border-gray-300 dark:border-zinc-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
            />
