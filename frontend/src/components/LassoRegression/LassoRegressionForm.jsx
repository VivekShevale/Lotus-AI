...
export default function LassoRegressionForm({
  onFileChange,
  onTargetChange,
  targetColumn,
  columns,
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <p className="mt-1 text-xs text-gray-500 dark:text-zinc-400">
              Higher values increase regularization (feature selection)
            </p>
          </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <h4 className="font-semibold text-gray-800 dark:text-zinc-200 text-sm mb-2">
                Lasso Regression Information
              </h4>
              <div className="text-xs text-gray-600 dark:text-zinc-400 space-y-1">
                <p>
                  <span className="font-medium">Lasso Regression:</span> Linear
                  model with L1 regularization for feature selection
                </p>
                <p>
                  <span className="font-medium">Alpha:</span> Higher values
                  increase regularization, setting some coefficients to zero
                </p>
                <p>
