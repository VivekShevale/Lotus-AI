...
export default function RandomForestForm({
  onFileChange,
  onTargetChange,
  targetColumn,
  columns,
    ...
    <div className="p-6 rounded-lg border border-gray-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 shadow-sm">
      ...
      <div className="space-y-6">
        ...
        <input
            ...
            className="w-full p-3 rounded-lg bg-white dark:bg-zinc-800 border border-gray-300 dark:border-zinc-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
            placeholder="Number of trees in the forest"
        />
        ...
        <input
            ...
            className="w-full p-3 rounded-lg bg-white dark:bg-zinc-800 border border-gray-300 dark:border-zinc-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
            placeholder="Leave empty for unlimited depth"
        />
        <p className="text-xs text-gray-500 dark:text-zinc-400 mt-1">
            Maximum depth of each tree. None = expand until leaves are pure
        </p>
        </div>
        ...
        <select
            value={classWeight}
            onChange={(e) => setClassWeight(e.target.value === "null" ? null : e.target.value)}
            className="w-full p-3 rounded-lg bg-white dark:bg-zinc-800 border border-gray-300 dark:border-zinc-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
        >
            <option value="null">None (balanced)</option>
            <option value="balanced">Balanced (auto)</option>
            <option value="balanced_subsample">Balanced Subsample</option>
        </select>
        <p className="text-xs text-gray-500 dark:text-zinc-400 mt-1">
            Weights associated with classes for imbalanced datasets
        </p>
        </div>
